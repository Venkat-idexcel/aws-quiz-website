#!/usr/bin/env python3
"""
Simple Database Import Script for AWS Practice Test 20 Questions
Uses the same database connection pattern as the main Flask app
"""
...
# Add the current directory to Python path so we can import from the main app
sys.path.append(os.path.dirname(os.path.abspath(__file__)))

# Import the database utility from the main app
